...
def validate_fiverr(user: str) -> Result:
    ...
    try:
        ...
        if response.status_code == 200 and final_url != "https://www.fiverr.com/":
            return Result.taken(url=url)
        elif response.status_code == 404 or final_url == "https://www.fiverr.com/" or "/errors/" in final_url:
