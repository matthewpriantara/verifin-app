...
from test_osint import check_domain_age, check_email_security, scan_email_osint, scan_username_osint
...
@app.get("/api/v1/osint/scan-email")
...
@app.get("/api/v1/osint/scan-username")
